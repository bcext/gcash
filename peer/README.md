...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bcext/gcash/peer)
...
```bash
$ go get -u github.com/bcext/gcash/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/bcext/gcash/peer#example-package--NewOutboundPeer)  
