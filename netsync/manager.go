...
import (
	...
	peerpkg "github.com/bcext/gcash/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*cashutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *cashutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *cashutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *cashutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
