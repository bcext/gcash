...
const (
	...
	DefaultMinRelayTxFee = cashutil.Amount(1000)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee cashutil.Amount) int64 {
	...
	if minFee < 0 || minFee > cashutil.MaxSatoshi {
		minFee = cashutil.MaxSatoshi
	}
...
func checkInputsStandard(tx *cashutil.Tx, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee cashutil.Amount) bool {
...
func checkTransactionStandard(tx *cashutil.Tx, height int32,
	medianTimePast time.Time, minRelayTxFee cashutil.Amount,
