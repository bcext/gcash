...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bcext/gcash/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/bcext/gcash/mining/cpuminer
```
