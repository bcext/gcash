...
// reference implementation because gcash does not handle wallet requests.  The
// separate wallet process listens on the well-known port and forwards requests
// it does not handle on to gcash.  This approach allows the wallet process
...
// time of writing, gcash currently places blocks for testnet version 3 in the
