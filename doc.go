...
/*
gcash is a full-node bitcoin cash implementation written in Go.

The default options are sane for most users.  This means gcash will work 'out of
...
parsed when gcash starts up.  By default, the configuration file is located at
~/.gcash/gcash.conf on POSIX-style operating systems and %LOCALAPPDATA%\gcash\gcash.conf
