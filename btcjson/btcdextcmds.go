...
// a chain server with gcash extensions.
...
// standard Bitcoin command.  It is an extension for gcash.
...
// NewGenerateToAddressCmd returns a new instance which can be used to issue a generate
// JSON-RPC command.
