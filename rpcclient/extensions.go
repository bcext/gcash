...
//
// NOTE: This is a cashwallet extension.
...
// managed by cashwallet are only written to disk with encrypted private keys,
...
// used by cashwallet to enable a wallet which does not have the private keys
