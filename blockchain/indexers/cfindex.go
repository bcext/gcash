...
func storeFilter(dbTx database.Tx, block *cashutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *cashutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *cashutil.Block,
