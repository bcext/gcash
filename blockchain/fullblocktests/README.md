...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bcext/gcash/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/bcext/gcash/blockchain/fullblocktests
```
