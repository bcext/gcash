...
func (b *BlockChain) FetchSpendJournal(targetBlock *cashutil.Block) ([]SpentTxOut, error) {
	b.chainLock.RLock()
...
func dbFetchSpendJournalEntry(dbTx database.Tx, block *cashutil.Block) ([]SpentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := cashutil.NewBlock(b.chainParams.GenesisBlock)
...
// raw block for the provided node, deserialize it, and return a cashutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*cashutil.Block, error) {
...
func dbStoreBlock(dbTx database.Tx, block *cashutil.Block) error {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int32) (*cashutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*cashutil.Block, error) {
