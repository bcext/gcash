...
func (view *UtxoViewpoint) AddTxOut(tx *cashutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *cashutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *cashutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *cashutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *cashutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *cashutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *cashutil.Tx) (*UtxoViewpoint, error) {
